...
CAR_DB = {
    ...
    "Formula": {
        ...
        "Formula Vee": {
            "drivetrain": "RWD, luftkølet bagmotor (lav effekt), ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (60, 120), "unit": "N/mm"},
                "spring_r":       {"range": (60, 120), "unit": "N/mm"},
                "camber_f":       {"range": (-3.0, -1.0), "unit": "°"},
                "camber_r":       {"range": (-2.0, -0.5), "unit": "°"},
                "toe_f":          {"range": (-0.10, 0.10), "unit": "° pr. hjul"},
                "ride_height_f":  {"range": (30, 55), "unit": "mm"},
                "ride_height_r":  {"range": (35, 60), "unit": "mm"},
                "brake_bias":     {"range": (55, 65), "unit": "% front"},
                "tire_pressure":  {"range": (16, 22), "unit": "psi (kold)"},
            },
            "notes": "Meget lav effekt og ingen aero — det er nærmest ren kart-fysik. Mekanisk grip via camber/toe betyder alt, ingen downforce at spille med.",
        },
        "Super Formula SF23": {
            "drivetrain": "RWD, open-wheel, høj downforce, ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (150, 280), "unit": "N/mm"},
                "spring_r":       {"range": (150, 280), "unit": "N/mm"},
                "arb_f":          {"range": (1, 10), "unit": "trin"},
                "arb_r":          {"range": (1, 10), "unit": "trin"},
                "camber_f":       {"range": (-4.5, -2.5), "unit": "°"},
                "camber_r":       {"range": (-3.0, -1.0), "unit": "°"},
                "ride_height_f":  {"range": (15, 35), "unit": "mm"},
                "ride_height_r":  {"range": (25, 50), "unit": "mm"},
                "brake_bias":     {"range": (50, 60), "unit": "% front"},
                "wing_f":         {"range": (1, 10), "unit": "trin"},
                "wing_r":         {"range": (1, 10), "unit": "trin"},
                "tire_pressure":  {"range": (20, 27), "unit": "psi (kold)"},
            },
            "notes": "Højeste downforce/effekt-niveau i Formula-klassen på rosteret — meget lav ride height, ekstremt setup-følsom i høje sving.",
        },
        "iRacing Indycar (Dallara IR18)": {
            "drivetrain": "RWD, open-wheel, road/oval hybrid-kit, ingen ABS",
            "params": {
                "spring_f":       {"range": (140, 260), "unit": "N/mm"},
                "spring_r":       {"range": (140, 260), "unit": "N/mm"},
                "camber_f":       {"range": (-4.0, -2.0), "unit": "°"},
                ...
                "wing_f":         {"range": (1, 10), "unit": "trin"},
                "wing_r":         {"range": (1, 10), "unit": "trin"},
                "tire_pressure":  {"range": (22, 30), "unit": "psi (kold)"},
            },
            "notes": "To vidt forskellige setup-filosofier afhængig af road/oval-kit — på road course minder tuning om GTP, på oval er wedge/cross-weight vigtigere end ARB.",
        },
        "Ray FF1600": {
            "drivetrain": "RWD, letvægt open-wheel, ingen aero, ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (70, 140), "unit": "N/mm"},
                "spring_r":       {"range": (70, 140), "unit": "N/mm"},
                "camber_f":       {"range": (-3.0, -1.0), "unit": "°"},
                "camber_r":       {"range": (-2.0, -0.5), "unit": "°"},
                "ride_height_f":  {"range": (25, 50), "unit": "mm"},
                "ride_height_r":  {"range": (30, 55), "unit": "mm"},
                "brake_bias":     {"range": (54, 64), "unit": "% front"},
                "tire_pressure":  {"range": (18, 24), "unit": "psi (kold)"},
            },
            "notes": "Ingen aero overhovedet — rent mekanisk grip-spil. Klassisk 'lær at køre'-bil, hver fejl i linje eller inputs straffes direkte i tempo.",
        },
    },
    "TCR": {
    ...
    "Oval": {
        ...
        "NASCAR Xfinity Next Gen": {
            "drivetrain": "RWD, symmetrisk chassis, ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (650, 1300), "unit": "lb/in"},
                "spring_r":       {"range": (130, 320), "unit": "lb/in"},
                "camber_lf":      {"range": (-3.5, 0.0), "unit": "°"},
                "camber_rf":      {"range": (-1.0, 3.0), "unit": "°"},
                "wedge_crossweight": {"range": (48, 54), "unit": "% cross"},
                "trackbar_height":{"range": (5, 15), "unit": "tommer"},
                "tire_pressure":  {"range": (18, 30), "unit": "psi (kold, LF ofte lavest)"},
            },
            "notes": "Lettere og mindre power end Cup — samme asymmetriske setup-filosofi, men bilen tåler generelt lidt mere aggressiv wedge uden at blive urimelig.",
        },
        "NASCAR Truck": {
            "drivetrain": "RWD, høj tyngdepunkt (truck-karrosseri), ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (600, 1200), "unit": "lb/in"},
                "spring_r":       {"range": (125, 300), "unit": "lb/in"},
                "camber_lf":      {"range": (-3.5, 0.0), "unit": "°"},
                "camber_rf":      {"range": (-1.0, 2.5), "unit": "°"},
                "wedge_crossweight": {"range": (47, 53), "unit": "% cross"},
                "trackbar_height":{"range": (5, 14), "unit": "tommer"},
                "tire_pressure":  {"range": (18, 28), "unit": "psi (kold, LF ofte lavest)"},
            },
            "notes": "Højere tyngdepunkt end Cup/Xfinity giver mere rulning — lidt stivere ARB-balance og lavere trackbar hjælper ofte med at holde bagenden under kontrol.",
        },
        "Late Model Stock": {
            "drivetrain": "RWD, kort-oval stock car, ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (500, 1000), "unit": "lb/in"},
                "spring_r":       {"range": (100, 250), "unit": "lb/in"},
                "camber_lf":      {"range": (-3.0, 0.0), "unit": "°"},
                "camber_rf":      {"range": (-1.0, 2.5), "unit": "°"},
                "wedge_crossweight": {"range": (48, 55), "unit": "% cross"},
                "trackbar_height":{"range": (4, 12), "unit": "tommer"},
                "tire_pressure":  {"range": (16, 26), "unit": "psi (kold, LF ofte lavest)"},
            },
            "notes": "Kort-oval-bil — meget mere wedge-følsom end de større ovals pga. lav hastighed/høj lateral last relativt til vægt. Små wedge-justeringer flytter balancen markant.",
        },
        "Legends Ford '34 Coupe": {
            "drivetrain": "RWD, letvægt kort-oval, ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (300, 600), "unit": "lb/in"},
                "spring_r":       {"range": (80, 180), "unit": "lb/in"},
                "camber_lf":      {"range": (-3.0, 0.0), "unit": "°"},
                "camber_rf":      {"range": (-1.0, 2.0), "unit": "°"},
                "wedge_crossweight": {"range": (48, 55), "unit": "% cross"},
                "tire_pressure":  {"range": (14, 22), "unit": "psi (kold)"},
            },
            "notes": "Lille, let bil på minimal-ovaler — meget nervøs, føles og reagerer nærmere en kart end en stock car. Bittesmå wedge/tryk-ændringer har stor effekt.",
        },
        "Super Late Model": {
            "drivetrain": "RWD, høj effekt kort-oval, ingen ABS/TC",
            "params": {
                "spring_f":       {"range": (550, 1100), "unit": "lb/in"},
                "spring_r":       {"range": (110, 280), "unit": "lb/in"},
                "camber_lf":      {"range": (-3.5, 0.0), "unit": "°"},
                "camber_rf":      {"range": (-1.0, 2.5), "unit": "°"},
                "wedge_crossweight": {"range": (48, 55), "unit": "% cross"},
                "trackbar_height":{"range": (4, 13), "unit": "tommer"},
                "tire_pressure":  {"range": (16, 26), "unit": "psi (kold, LF ofte lavest)"},
            },
            "notes": "Mest power-tunge kort-oval-bil på rosteret — traktion ud af sving er den evige kamp, ofte løst med wedge/trackbar frem for spring alene.",
        },
    },
}
